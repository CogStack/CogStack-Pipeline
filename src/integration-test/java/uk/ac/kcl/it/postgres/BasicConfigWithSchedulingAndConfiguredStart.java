...
import uk.ac.kcl.testservices.BasicConfigWithSchedulingAndConfiguredStartTests;
...
public class BasicConfigWithSchedulingAndConfiguredStart {
    ...
    @Autowired
    BasicConfigWithSchedulingAndConfiguredStartTests basicConfigWithSchedulingAndConfiguredStartTests;

    @Test
    @DirtiesContext
    public void basicConfigWithSchedulingAndConfiguredStart(){
        basicConfigWithSchedulingAndConfiguredStartTests.basicConfigurerdStartPkPartitionWithSchedulingTest();
    }
