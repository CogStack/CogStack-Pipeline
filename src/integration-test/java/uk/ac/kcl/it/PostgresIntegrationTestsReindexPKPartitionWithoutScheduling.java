...
@TestPropertySource({
        ...
        "classpath:postgres_test_config_reindex.properties",
...
@TestExecutionListeners(
        listeners = PostgresReindexTestExecutionListener.class,
        mergeMode = TestExecutionListeners.MergeMode.MERGE_WITH_DEFAULTS)
public class PostgresIntegrationTestsReindexPKPartitionWithoutScheduling {
