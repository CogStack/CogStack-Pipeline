...
( cd ../dockerfiles/java ; docker build -t cogstacksystems/cogstack-java-devel:$VERSION_TAG -f Dockerfile.devel . )
echo ""

echo "--------------------------------"
echo "building image: cogstacksystems/cogstack-java-run:$VERSION_TAG"
( cd ../dockerfiles/java ; docker build -t cogstacksystems/cogstack-java-run:$VERSION_TAG -f Dockerfile.run . )
echo ""

echo "--------------------------------"
echo "building image: cogstacksystems/fluentd:$VERSION_TAG"
( cd ../../dockerfiles/fluentd ; docker build -t cogstacksystems/fluentd:$VERSION_TAG . )
echo ""
